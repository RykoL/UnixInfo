...
debug:
	g++ main.cpp -I $(HEADER_DIRECTORY) $(SOURCE_FILES) $(CXX_FLAGS) -g -o $(PROJ_DEBUG)t1

release:
	g++ main.cpp -I $(HEADER_DIRECTORY) $(SOURCE_FILES) $(CXX_FLAGS) -o $(PROJ_RELEASE)t1 && $(PROJ_RELEASE)/./t1
